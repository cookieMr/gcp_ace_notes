# Google Cloud Firestore — ACE Exam Study Guide
...
- **Transactions** → read + write, atomic
...
## 12. Queries & Aggregations (2026 Update)
...
## 14. Data Retention & Recovery (Critical for ACE)
...
- **Scenario: Automate deletion of 30-day-old logs?** → Enable **TTL** on a timestamp field.
...
| Topic           | Key Points                                                   |
| :-------------- | :----------------------------------------------------------- |
| **Data model**  | Collections → Documents → Fields (Max 1 MB)                  |
