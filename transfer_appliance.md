# GCP Transfer Appliance Study Guide
...
- Capacity: Available in different sizes, typically 40TB, 300TB, or more (depending on current hardware offerings).
...
3. Prepare & Capture: You connect the appliance to your local network and copy your data onto it.
...
6. Verify & Wipe: You verify the data in GCS. Google then securely wipes the appliance according to NIST 800-88 standards.
