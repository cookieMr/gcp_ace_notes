# GCP Migrate to Virtual Machines (M2VM) Study Guide

[Back to root](./README.md)

## 1. Overview and Use Cases

Migrate to Virtual Machines is a "lift-and-shift" (Rehost) solution used to migrate physical or virtual machines into Compute Engine. It was previously known as "Migrate for Compute Engine".
...
- Migration Center: The unified platform for discovery, assessment, and planning. It replaces older standalone assessment tools.
...
- IAM Roles:
  ...
  - The Service Account used by the connector needs `storage.admin` and `compute.admin` permissions in the host/target projects.

## 5. Key Exam "Gotchas" and Tips
...
- Post-Migration: Once cutover is finished, Guest Packages (if not done automatically) should be verified for integration with GCP metadata and monitoring.
