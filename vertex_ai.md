# GCP Vertex AI and AI Services Study Guide (2026 ACE Exam)
...
- **Gemini Models:** Integrated directly into Vertex AI. You should know that Gemini can be accessed via Vertex AI Studio for prototyping and then deployed as part of an application.
- **Vertex AI Search and Conversation:** Managed services for building AI-powered search and chat interfaces with minimal coding.
