# GCP Cloud Interconnect: ACE Exam Study Guide (2026)
...
- **Key Characteristics:**
  ...
  - **Security:** High security due to physical isolation, though traffic is not encrypted by default (unlike IPsec VPN).

## 2. Interconnect Types (The Most Important Exam Distinction)

GCP offers two primary types: **Dedicated Interconnect** and **Partner Interconnect**.
...
- **Encryption:** Remember that Cloud Interconnect does **not** encrypt traffic by default. If encryption is required, you must run **HA VPN over Interconnect**.
